...
public class com_example_said_tubes_akb_UserRealmProxy extends com.example.said.tubes_akb.User
    implements RealmObjectProxy, com_example_said_tubes_akb_UserRealmProxyInterface {
    ...
    private ProxyState<com.example.said.tubes_akb.User> proxyState;

    com_example_said_tubes_akb_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.said.tubes_akb.User>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.said.tubes_akb.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.example.said.tubes_akb.User obj = null;
        if (update) {
            Table table = realm.getTable(com.example.said.tubes_akb.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.example.said.tubes_akb.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.said.tubes_akb.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_example_said_tubes_akb_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("nama")) {
                if (json.isNull("nama")) {
                    obj = (io.realm.com_example_said_tubes_akb_UserRealmProxy) realm.createObjectInternal(com.example.said.tubes_akb.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_said_tubes_akb_UserRealmProxy) realm.createObjectInternal(com.example.said.tubes_akb.User.class, json.getString("nama"), true, excludeFields);
                }
            } else {
        ...
        final com_example_said_tubes_akb_UserRealmProxyInterface objProxy = (com_example_said_tubes_akb_UserRealmProxyInterface) obj;
        if (json.has("nim")) {
            if (json.isNull("nim")) {
    ...
    public static com.example.said.tubes_akb.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.example.said.tubes_akb.User obj = new com.example.said.tubes_akb.User();
        final com_example_said_tubes_akb_UserRealmProxyInterface objProxy = (com_example_said_tubes_akb_UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_example_said_tubes_akb_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.example.said.tubes_akb.User.class), false, Collections.<String>emptyList());
        io.realm.com_example_said_tubes_akb_UserRealmProxy obj = new io.realm.com_example_said_tubes_akb_UserRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.example.said.tubes_akb.User copyOrUpdate(Realm realm, UserColumnInfo columnInfo, com.example.said.tubes_akb.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.said.tubes_akb.User) cachedRealmObject;
        }

        com.example.said.tubes_akb.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.example.said.tubes_akb.User.class);
            long pkColumnIndex = columnInfo.namaIndex;
            String value = ((com_example_said_tubes_akb_UserRealmProxyInterface) object).realmGet$nama();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_example_said_tubes_akb_UserRealmProxy();
    ...
    public static com.example.said.tubes_akb.User copy(Realm realm, UserColumnInfo columnInfo, com.example.said.tubes_akb.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.example.said.tubes_akb.User) cachedRealmObject;
        }

        com_example_said_tubes_akb_UserRealmProxyInterface realmObjectSource = (com_example_said_tubes_akb_UserRealmProxyInterface) newObject;
        ...
        io.realm.com_example_said_tubes_akb_UserRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.example.said.tubes_akb.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.example.said.tubes_akb.User.class);
        long pkColumnIndex = columnInfo.namaIndex;
        String primaryKeyValue = ((com_example_said_tubes_akb_UserRealmProxyInterface) object).realmGet$nama();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$nim = ((com_example_said_tubes_akb_UserRealmProxyInterface) object).realmGet$nim();
        if (realmGet$nim != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nimIndex, rowIndex, realmGet$nim, false);
        }
        String realmGet$notelp = ((com_example_said_tubes_akb_UserRealmProxyInterface) object).realmGet$notelp();
        if (realmGet$notelp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.notelpIndex, rowIndex, realmGet$notelp, false);
        }
        String realmGet$email = ((com_example_said_tubes_akb_UserRealmProxyInterface) object).realmGet$email();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.example.said.tubes_akb.User.class);
        long pkColumnIndex = columnInfo.namaIndex;
        com.example.said.tubes_akb.User object = null;
        while (objects.hasNext()) {
            object = (com.example.said.tubes_akb.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.said.tubes_akb.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.said.tubes_akb.User.class);
    ...
    public static com.example.said.tubes_akb.User createDetachedCopy(com.example.said.tubes_akb.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.said.tubes_akb.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.said.tubes_akb.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.said.tubes_akb.User) cachedObject.object;
            }
            unmanagedObject = (com.example.said.tubes_akb.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_said_tubes_akb_UserRealmProxyInterface unmanagedCopy = (com_example_said_tubes_akb_UserRealmProxyInterface) unmanagedObject;
        com_example_said_tubes_akb_UserRealmProxyInterface realmSource = (com_example_said_tubes_akb_UserRealmProxyInterface) realmObject;
    ...
    static com.example.said.tubes_akb.User update(Realm realm, UserColumnInfo columnInfo, com.example.said.tubes_akb.User realmObject, com.example.said.tubes_akb.User newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_example_said_tubes_akb_UserRealmProxyInterface realmObjectTarget = (com_example_said_tubes_akb_UserRealmProxyInterface) realmObject;
        com_example_said_tubes_akb_UserRealmProxyInterface realmObjectSource = (com_example_said_tubes_akb_UserRealmProxyInterface) newObject;
        Table table = realm.getTable(com.example.said.tubes_akb.User.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addString(columnInfo.namaIndex, realmObjectSource.realmGet$nama());
    ...
    public boolean equals(Object o) {
        ...
        com_example_said_tubes_akb_UserRealmProxy aUser = (com_example_said_tubes_akb_UserRealmProxy)o;
